...
<body>
		...
		<table>
			...
			<tr>
				...
				<td><input type="password" name="pw"
					placeholder="비밀번호 수정을 원치 않으면 입력하지 마세요"
				></td>
			</tr>
			<tr>
				<th>새비밀번호확인</th>
	...
	out.print("selected='selected'");
			...
			<tr>
				...
				<td>
					...
					value="m" id="m" checked="checked"
				><label for="m">남자</label> <input type="radio" name="gender"
					value="f" id="f"
 ...
 %>
					...
					for="m"
				>남자</label> <input type="radio" name="gender" value="f" id="f"
					checked="checked"
				><label for="f">여자</label> <%
 	} else { // 성별이 null인 경우
 %> <input
