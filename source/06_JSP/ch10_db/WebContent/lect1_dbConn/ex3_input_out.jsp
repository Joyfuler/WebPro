...
<body>
	...
	<%
	sql = "SELECT EMPNO, ENAME, HIREDATE, EMP.DEPTNO, DNAME" 
	+ " FROM EMP,DEPT" 
	...
	try{
		...
		if (rs.next()){
			...
			do{
				...
				int deptno = rs.getInt("deptno");
				String dname = rs.getString("dname");				
				out.println("<tr><td>"+empno+"</td><td>"+ename+"</td><td>"+hiredate+"</td><td>"+deptno+"</td><td>"+dname+"</td>");
			} while (rs.next());
		} else {
