...
이름: <jsp:getProperty name="student" property="name" /> 님<br>
학년: <jsp:getProperty name="student" property="grade" />학년<br>
반이름: <jsp:getProperty name="student" property="className" />반<br>
점수: <jsp:getProperty name="student" property="score" />점
