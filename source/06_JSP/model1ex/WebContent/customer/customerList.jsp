...
out.println("<table><tr><td><b>아이디</b></td><td><b>비밀번호</b></td><td><b>이름</b></td><td><b>이메일</b></td><td><b>주소</b></td></tr>");
...
<%if (startPage > BLOCKSIZE){%> 	
	<a href = "<%=conPath%>/customer/customerList.jsp?pageNum=<%=startPage-1%>">[이전]</a>		
<%}%>
...
if (endPage < pageCnt){%>
	<a href = "<%=conPath%>/customer/customerList.jsp?pageNum=<%=endPage+1%>">[다음]</a>
<%}
