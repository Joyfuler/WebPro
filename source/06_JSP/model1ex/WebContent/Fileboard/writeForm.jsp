...
<body>
	...
	<form action="<%=conPath%>/Fileboard/writePro.jsp" method="post"
		enctype="multipart/form-data">
		<input type="hidden" name="cid"
			value="<%=customer.getCid() == null ? "aaa1" : customer.getCid()%>">
		<table>
			...
			<tr>
				<td colspan="2"><input type="submit" value="게시글작성" class="btn">
