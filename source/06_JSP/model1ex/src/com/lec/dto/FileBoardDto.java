...
public class FileBoardDto {
	...
	public FileBoardDto(int fid, String cid, String ftitle, String fcontent, String filename, int fhit, String fpw,
			int fgroup, int fstep, int findent, String fip, Date frdate) {
		super();
		this.fid = fid;
		this.cid = cid;
		this.ftitle = ftitle;
	...
	public FileBoardDto(int fid, String cid, String cemail, String ftitle, String fcontent, String filename, int fhit, String fpw,
			int fgroup, int fstep, int findent, String fip, Date frdate) {
		super();
		this.fid = fid;
		this.cid = cid;
	...
	public String toString() {
		return "FileBoardDto [fid=" + fid + ", cid=" + cid + ", ftitle=" + ftitle + ", fcontent=" + fcontent
				...
				+ fstep + ", findent=" + findent + ", fip=" + fip + ", frdate=" + frdate + "]";
	}	
}
