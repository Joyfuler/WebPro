...
public class BoardDto {
	...
	public BoardDto(int fid, String ftitle, String fcontent, String ffilename, Date frdate, int fhit, int fgroup,
			int fstep, int findent, String fip, String mid, String mname) {
		super();
		this.fid = fid;
		this.ftitle = ftitle;
	...
	public String toString() {
		return "BoardDto [fid=" + fid + ", ftitle=" + ftitle + ", fcontent=" + fcontent + ", ffilename=" + ffilename
				+ ", frdate=" + frdate + ", fhit=" + fhit + ", fgroup=" + fgroup + ", fstep=" + fstep + ", findent="
				+ findent + ", fip=" + fip + ", mid=" + mid + "]";
	}
