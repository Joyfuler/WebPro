...
<body>
	<c:if test="${empty member }">
		<script>
			...
			location.href = '${conPath}/member/login.do?after=book/bookModify.do?bnum=${param.bnum}&pageNum=${param.pageNum}';
		</script>
	</c:if>
	...
	<div id="content">
		<form action="${conPath }/book/bookModify.do" method="post"  enctype="multipart/form-data">
			...
			<table>
				...
				<tr><td colspan="2">
					...
					<input type="button" value="목록" onclick="location='${conPath }/book/bookList.do?pageNum=${param.pageNum}'">
			</table>
		</form>
	</div>
