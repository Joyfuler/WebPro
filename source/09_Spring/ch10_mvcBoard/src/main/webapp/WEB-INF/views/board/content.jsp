	...
	<table>
		...
		<tr>
			<td colspan = "2"> 
				...
				<button onclick = "location.href='${conPath }/board/delete.do?bid=${param.bid }&pageNum=${param.pageNum }'">삭제</button>
				<!--  삭제해야 할 글 번호수를 알아야 하므로 bid 필요, 삭제 후 돌아가야 할 페이지를 알아야 하므로 pageNum도 필요. -->
				<button onclick = "location.href='${conPath }/board/reply.do?bid=${param.bid }&pageNum=${param.pageNum }'">답변</button>
