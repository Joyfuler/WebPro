    ...
    <div class="card mb-1 bg-dark container card1 card-container" style="max-width: 1000px;">
        <div class="row g-0">
          <div class="col-md-3">
            ...
            <img src="${conPath }/img/thum1.jpg" class="img-fluid rounded-start" alt="thumnail" onerror="noImage(this)">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title" style = "color:aqua;">&nbsp;&nbsp;세븐나이츠 키우기</h5>
              <h6 style = "color:white;">&nbsp;&nbsp;(평점: 4.89점<img src = "${conPath }/img/star_on.png" height="15px"><img src = "${conPath }/img/star_on.png" height="15px"><img src = "${conPath }/img/star_on.png" height="15px"><img src = "${conPath }/img/star_on.png" height="15px"><img src = "${conPath }/img/star_out.png" height="15px">)</h6>
